...
export interface LoanScheduleAccrualData {
  ...
  class GlobalConfigurationPropertyData {
    ...
    export function getAccountingRuleType(): AccountingRuleType {
        return AccountingRuleType.ACCRUAL_PERIODIC;
    }
    export function getLoanStatus(): LoanStatus {
        return LoanStatus.ACTIVE;
    }
    export function getLoanTransactionType(): LoanTransactionType {
        return LoanTransactionType.ACCRUAL;
    }
